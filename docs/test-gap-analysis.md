...
> **Note:** The verification script (`scripts/verify_test_parity.py`) and mapping overrides
> (`scripts/test_mapping_overrides.jsonl`) are no longer in the repository. The coverage
> data below was generated by the script before removal and has been verified manually.
