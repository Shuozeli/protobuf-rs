...
impl RustGen {
    ...
    fn gen_message(&mut self, msg: &DescriptorProto) -> Result<(), CodeGenError> {
        ...
        // Emit struct
        self.w.line("#[derive(Clone, PartialEq, ::prost::Message)]");
    ...
    fn gen_field(
        ...
        self.w.line(&format!("#[prost({prost_attr})]"));
    ...
    fn gen_enum(&mut self, e: &EnumDescriptorProto) -> Result<(), CodeGenError> {
        ...
        self.w.line(&format!("impl {rust_name} {{"));
        self.w.indent();

        self.w.line("pub fn as_str_name(&self) -> &'static str {");
        self.w.indent();
    ...
    fn gen_oneof_enum(
        ...
        self.w.line("#[derive(Clone, PartialEq, ::prost::Oneof)]");
        self.w.line(&format!("pub enum {rust_name} {{"));
        self.w.indent();
